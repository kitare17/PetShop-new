...
<div class="container mt-3">
    ...
    <p>Nhân viên có thể xem được danh sách đặt dịch vụ đã xác nhận ở đây</p>
    ...
    <table class="table table-bordered">
        ...
        <c:forEach var="order" items="${listServiceOrder}">
            <tr>
                ...
                <td>${order.day}</td>
                <td>${order.amount}</td>
                <td>${order.status==1?"Đã xác nhận":""}</td>
                <td><a href="paidserivebill?billID=${order.billID}" class="btn btn-success">Xác nhận thanh toán</a></td>
