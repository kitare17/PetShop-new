...
<nav class="nav nav-pills nav-justified">
  <a class="nav-item nav-link " href="updatepet?petID=${productId}">Thông tin chung</a>
  <a class="nav-item nav-link active" href="#">Quản lí hình ảnh</a>
</nav>
...
<div class="container">
  ...
  <div class="row ">
    <form class="needs-validation mt-3" novalidate action="pet-add-image" method="post">
  ...
  <table class="table table-bordered">
    ...
    <c:forEach var="img" items="${listImage}">
      <tr>
        ...
        <td>
          <c:if test="${listImage.size()!=1}">
            <a class="btn btn-danger" href="remove-pet?productId=${img.id}&urlImage=${img.url}" >Xóa</a>
          </c:if>
        </td>
      </tr>
